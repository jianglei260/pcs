    ...
    if(nomove(board)&& nospace(board))
	{
		...
		//alert(allCookies);
		 //var the_cookie = document.cookie;
   		 ...
   		 var nowvalue;
   		 var the_value = "playerName"
   		 for(var i = 0; i < broken_cookies.length; i++)
   		 {
   		 	nowvalue = broken_cookies[i];
   		 	if(nowvalue.substring(0, nowvalue.indexOf("=")) == "playName")
   		 	{
   		 		the_value = nowvalue.substring(nowvalue.indexOf("=") + 1, nowvalue.length);
   		 		break;
   		 	}
   		 }
   		 the_value = localStorage.playName;
   		 if(the_value == undefined)
   		 {
   		 	the_value = "playerName";
   		 }
			...
			$("#restartgamebutton").on('click',function(){
				...
				localStorage.playName = playName;
				alert(localStorage.playName);
			});
		    ...
		    gameover.css("width", "960px");
		    gameover.css("height", "960px");
